...
var disqus_config = function () {
  this.page.url = "https://colinfay.me/rpinterest-un-package-r-pour-acceder-a-lapi-pinterest/";
  this.page.identifier = "/rpinterest-un-package-r-pour-acceder-a-lapi-pinterest";
};
(function() {
