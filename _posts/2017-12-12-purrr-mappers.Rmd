...
I've been working lately on a new package called {attempt}, which is an attempt at making try catch and condition handling in R a little bit friendlier. If you have some time to spare, I'll be glad if you can give me some feedbacks about it: positive, negative, PR, improvement suggestions [https://github.com/ColinFay/attempt](https://github.com/ColinFay/attempt)... Feel free! 
...
+ A __function__ to be run on error
+ A __function__ to be run on warning
+ A __function__ to be run on exit
...
You can have a look at what {attempt} does on the [GitHub repo](https://github.com/ColinFay/attempt). 
