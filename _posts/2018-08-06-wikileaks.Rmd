...
All the pages have the same intro content, so I can use `shiny::includeMarkdown` to include it on each page (this way, I'll only need to update the content once if needed). Put ot between backticks with an `r`, and the markdown is integrated at compilation time as html. 
